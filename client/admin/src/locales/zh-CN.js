...
export default {
  ...
  'menu.auth.user-edit': '编辑用户',
  'menu.auth.role-list': '角色管理',
  'menu.auth.role-add': '添加角色',
  'menu.auth.role-edit': '编辑角色',
  'menu.auth.module-list': '模块管理',
  'menu.auth.module-add': '添加模块',
  'menu.auth.module-edit': '编辑模块',
  'menu.account.setting': '个人设置',
  'menu.account.update-password': '修改密码'
};
