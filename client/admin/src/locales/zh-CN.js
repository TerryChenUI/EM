...
export default {
  ...
  'menu.auth': '权限管理',
  'menu.auth.userlist': '用户管理',
  'menu.auth.useradd': '添加用户',
  'menu.auth.useredit': '编辑用户',
  'menu.auth.rolelist': '角色管理',
  'menu.auth.roleadd': '添加角色',
  'menu.auth.roleedit': '编辑角色',
  'menu.auth.modulelist': '模块管理',
  'menu.auth.moduleadd': '添加模块',
  'menu.auth.moduleedit': '编辑模块',
};
